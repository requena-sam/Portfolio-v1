...
<?php if (have_posts()): while (have_posts()): the_post(); ?>
    <main>
        ...
        <section class="confidential">
            ...
            <p>Nous accordons une importance capitale à la protection de vos données personnelles. Notre engagement se traduit par un traitement confidentiel de ces données et une utilisation strictement limitée au cadre initial de leur collecte. Il est à noter que vos données sont susceptibles d'être enregistrées dans nos bases de données et ne seront, en aucun cas, divulguées à des tiers sans votre consentement explicite. De plus, vous conservez en tout temps le droit de solliciter l'accès à vos données, leur rectification ou leur suppression.</p>
            ...
            <article class="confidential__card">
                <h3>CONTACT</h3>
                <p>Vous pouvez nous contacter aux coordonnées suivantes :<br> Téléphone : +32 (0)472 86 02 18 <br>Email : <a href="mailto:samrequena15@gmail.com">samrequena15@gmail.com</a></p>
            </article>
            <article class="confidential__card">
                <h3>HÉBERGEMENT</h3>
